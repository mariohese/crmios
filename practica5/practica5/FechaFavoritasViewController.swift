//
//  FechaFavoritasViewController.swift
//  practica5
//
...
class FechaFavoritasViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "MostrarFavoritos"{
            
            if let ftvc = segue.destination as? FavoritasTableViewController {
                
                ftvc.fechainicio = fechainicio.date
                ftvc.fechafin = fechafin.date
