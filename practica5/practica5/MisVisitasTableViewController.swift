//
//  MisVisitasTableViewController.swift
//  practica5
//
...
class MisVisitasTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "misvisitascell", for: indexPath) as! MisVisitasTableViewCell
    ...
    private func downloadVisits(){
        ...
        let strurl =  "https://dcrmt.herokuapp.com/api/users/tokenOwner/visits/flattened?token="+token+"&dateafter="+fecha1+"&datebefore="+fecha2
