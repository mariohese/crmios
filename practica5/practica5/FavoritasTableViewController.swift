//
//  FavoritasTableViewController.swift
//  practica5
//
...
class FavoritasTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "favoritascell", for: indexPath) as! FavoritasTableViewCell
        ...
        if let customer = visit["Customer"] as? [String:Any],
            ...
            cell.nombreFavoritas.text = name
            print(name)
        ...
        if let salesman = visit["Salesman"] as? [String:Any],
            ...
            if let img = imgCache[strurl] {
                ...
                cell.imagenFavoritas.image = img
    ...
    private func downloadVisits(){
        ...
        let strurl = "https://dcrmt.herokuapp.com/api/visits/flattened?token="+token+"&dateafter="+fecha1+"&datebefore="+fecha2+"&favourites=1"
